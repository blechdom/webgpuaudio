---
title: WebGPU Audio WebWorker Example
sidebar_position: 1
---
import React, { useCallback, useEffect, useRef } from 'react';
import GPUWorker from "worker-loader!../../src/workers/workerAudio.js";
  ...
  return (
    <>
      <ul>
        ...
        <li>Chunks of audio are generated in the Worker and then sent to the main thread to be process by the WebAudioAPI</li>
