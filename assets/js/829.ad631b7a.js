...
;// CONCATENATED MODULE: ./src/workers/passthrough.worker.js
...
const didPull=inputQueue.pull([input],FRAME_SIZE);if(didPull){const output=input.map(sample=>0.1*sample);outputQueue.push([output],FRAME_SIZE);}Atomics.store(atomicState,0,0);}}}});
